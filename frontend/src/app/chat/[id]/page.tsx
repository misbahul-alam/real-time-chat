  ...
  return (
    <ChatLayout isChatOpen={true}>
      <div className="h-screen overflow-hidden">
        <div className="px-4 h-14 border-b border-gray-200 flex items-center sticky top-0 bg-white z-10">
          <div>
            <div className="flex items-center gap-2 ">
              <Link href="/">
                <MdArrowBack className="text-2xl md:hidden" />
              </Link>
        ...
        <div className="h-full max-h-[calc(100vh-104px)] bg-white shadow-sm">
